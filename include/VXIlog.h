 ...
 */
 ...
 typedef struct VXIlogInterface {
   ...
   /**
    * @name EventVector
    * @memo Log an event (VXIVector variant)
    *
    * NOTE: This is only available as of version 1.1 of the VXIlogInterface,
    *       use LOG_EVENT_VECTOR_SUPPORTED( ) to determine availability.
    *
    * @doc
    ...
    * event logging of recognition results)
    *
    * @param  eventID      [IN] Event number to log, this is mapped to a
    *                      localized event name that is placed in the event
    *                      log. It is critical that this provide unambiguous
   ...
   /**
    * @name ContentClose
    * @memo Close a stream for logging (potentially large or binary) content
    *
    * NOTE: This is only available as of version 1.1 of the VXIlogInterface,
    *       use LOG_CONTENT_METHODS_SUPPORTED( ) to determine availability.
    *
    * @doc Close a content stream that was previously opened. Closing
   ...
   /**
    * @name ContentWrite
    * @memo Write (potentially large or binary) content to a logging stream
    *
    * NOTE: This is only available as of version 1.1 of the VXIlogInterface,
    *       use LOG_CONTENT_METHODS_SUPPORTED( ) to determine availability.
    *
    * @doc Write data to a content stream that was previously opened.
    *
