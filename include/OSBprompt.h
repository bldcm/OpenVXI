 ...
 ***********************************************************************
 *
 * $Id: OSBprompt.h,v 1.11 2002/08/06 17:54:02 dmeyer Exp $
 * 
 ************************************************************************
 */
 ...
 *               function. Call OSBpromptDestroyResource( ) to delete the 
 *               resource.
 *
 * @result VXIprompt_RESULT_SUCCESS on success 
 */
OSBPROMPT_API 
VXIpromptResult OSBpromptCreateResource (VXIlogInterface     *log,
